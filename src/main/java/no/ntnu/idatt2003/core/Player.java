 ...
 *</ul>
 *
 * The player's current balance is tracked by {@code money}, while {@code startingMoney}
 * stores the original capital for reference in game status calculations.
 */
public class Player {
   ...
   * @throws IllegalArgumentException if {@code name} or {@code staringMoney} is null or <= 0.
   */
   ...
   * @throws IllegalArgumentException if {@code amount} is null, <= 0, or exceeds current money
   */
